...
/* const extractRest = (arr) => arr.shift() ;
 * De base, vu qu'il n'y a aucune consigne interdisant l'utilisation du shift, j'aurai fait de cette manière, mais je comprends que je ne suis pas dans le principe de décomposition.
 */

const extractRest = ([, ...reste]) => reste;
/**
